import React, {type ChangeEventHandler, Component, type CSSProperties} from "react";
import {connect} from "react-redux";
import {type State} from "../../models/State";
import {type PortalDispatch} from "../../store";
import {
	makeQuerySubmittable, updateFileName, updateSearchOption, updateSelectedPids
} from "../../actions/search";
...
import {publicQueries, type QueryName} from "../../config";
		...
		return (
			<>
				<FilterPanel header="Text filters">
					<FilterByPid {...{
						filterPids, filterFileName, updateSelectedPids, showDeprecated
					}} />
...
function getQueryBuilder(state: State): (queryName: QueryName) => string {
	...
	const lookup: Record<QueryName, QueryThunk> = {
