...
import {type Sha256Str, type AsyncResult, type UrlStr} from "../backend/declarations";
import {
	type fetchKnownDataObjects,
	type getExtendedDataObjInfo,
	type BootstrapData
} from "../backend";
import {type ColNames, type OriginsColNames, type SpecTableSerialized} from "../models/CompositeSpecTable";
import {type Filter} from "../models/SpecTable";
import type SpecTable from "../models/SpecTable";
import {type HelpItem} from "../models/HelpStorage";
import type Cart from "../models/Cart";
import type FilterTemporal from "../models/FilterTemporal";
import {type SearchOption} from "../actions/types";
...
export class BootstrapRouteMetadata extends BootstrapRoutePayload {
	constructor(readonly id: UrlStr, readonly metadata: MetaDataWStats, readonly objectsTable?: ObjectsTableLike) {
		super();
	}
}

export class BootstrapRouteCart extends BootstrapRoutePayload {
	constructor(readonly extendedDobjInfo: AsyncResult<typeof getExtendedDataObjInfo>, readonly objectsTable: ObjectsTableLike, readonly labelLookup?: LabelLookup) {
		super();
	}
}

export class BackendUserInfo extends BackendPayload {
	constructor(readonly user: WhoAmI, readonly profile: object) {
		super();
	}
}

export class BootstrapInfo extends BackendPayload {
	constructor(readonly info: BootstrapData) {
		super();
	}
}
...
export class BackendUpdateSpecFilter extends BackendPayload {
	constructor(readonly varName: ColNames | "keywordFilter", readonly filter: Filter) {
		super();
	}
}

export class BackendObjectMetadataId extends BackendPayload {
	constructor(readonly id: UrlStr) {
		super();
	}
}
...
export class BackendExtendedDataObjInfo extends BackendPayload {
	constructor(readonly extendedDobjInfo: AsyncResult<typeof getExtendedDataObjInfo>) {
		super();
	}
}

export class BackendTsSettings extends BackendPayload {
	constructor(readonly tsSettings: TsSettings) {
		super();
	}
}
...
export class BackendBatchDownload extends BackendPayload {
	constructor(readonly isBatchDownloadOk: boolean, readonly user: WhoAmI) {
		super();
	}
}
...
export class BackendObjectsFetched extends BackendPayload {
	constructor(readonly objectsTable: ObjectsTableLike, readonly isDataEndReached: boolean) {
		super();
	}
}

export class BackendKeywordsFetched extends BackendPayload {
	constructor(readonly scopedKeywords: string[]) {
		super();
	}
}

export class BackendExportQuery extends BackendPayload {
	constructor(readonly isFetchingCVS: boolean, readonly sparqClientQuery: string) {
		super();
	}
}
...
export class MiscLoadError extends MiscPayload {
	constructor(readonly state: StateSerialized, readonly cart: Cart) {
		super();
	}
}

export class MiscRestoreFromHistory extends MiscPayload {
	constructor(readonly historyState: StateSerialized) {
		super();
	}
}
...
export class MiscUpdateSearchOption extends MiscPayload {
	constructor(readonly newSearchOption: SearchOption) {
		super();
	}
}

export class MiscUpdateMapProps extends MiscPayload {
	constructor(readonly persistedMapProps: PersistedMapPropsExtended) {
		super();
	}
}

export class MiscUpdateAddToCart extends MiscPayload {
	constructor(readonly addToCart: Sha256Str[] | undefined) {
		super();
	}
}
...
export class SetPreviewFromCart extends PreviewPayload {
	constructor(readonly ids: UrlStr[]) {
		super();
	}
}

export class SetPreviewUrl extends PreviewPayload {
	constructor(readonly url: UrlStr) {
		super();
	}
}
...
export class UiStepRequested extends UiPayload {
	constructor(readonly direction: -1 | 1) {
		super();
	}
}

export class UiSwitchTab extends UiPayload {
	constructor(readonly tabName: string, readonly selectedTabId: number) {
		super();
	}
}

export class UiUpdateHelpInfo extends UiPayload {
	constructor(readonly helpItem: HelpItem) {
		super();
	}
}
...
export class UiUpdateCheckedObjsInSearch extends UiPayload {
	constructor(readonly checkedObjectInSearch: UrlStr | UrlStr[]) {
		super();
	}
}

export class UiUpdateCheckedObjsInCart extends UiPayload {
	constructor(readonly checkedObjectInCart: UrlStr | UrlStr[]) {
		super();
	}
}

export class FiltersTemporal extends FiltersPayload {
	constructor(readonly filterTemporal: FilterTemporal) {
		super();
	}
}

export class FiltersNumber extends FiltersPayload {
	constructor(readonly numberFilter: FilterNumber) {
		super();
	}
}

export class FilterKeywords extends FiltersPayload {
	constructor(readonly filterKeywords: string[]) {
		super();
	}
}

export class FiltersUpdatePids extends FiltersPayload {
	constructor(readonly selectedPids: Sha256Str[] | null) {
		super();
	}
}
