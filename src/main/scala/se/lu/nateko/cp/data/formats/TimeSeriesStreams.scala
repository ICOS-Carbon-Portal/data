...
//			lastBin <- lastBinFut
//		) yield{
//			// TODO: How can I get the list of column names
//			val start = TimeSeriesToBinTableConverter.recoverTimeStamp(firstBin.cells, formats, formats.timeStampColumn)
//			val stop = TimeSeriesToBinTableConverter.recoverTimeStamp(lastBin.cells, formats, formats.timeStampColumn)
