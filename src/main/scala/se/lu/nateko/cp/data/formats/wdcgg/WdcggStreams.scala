...
//import se.lu.nateko.cp.data.formats.ColumnsMetaWithTsCol
...
//
//
//	def wdcggToBinTableConverter(formats: ColumnsMetaWithTsCol)(implicit ctxt: ExecutionContext): Flow[WdcggRow, BinTableRow, Future[WdcggUploadCompletion]] = {
