...
class MetadataClient:
	...
	def get_station_meta(self, station: str | StationLite) -> StationWithStaff:
		...
		:return: Python dataclass `StationWithStaff` whose definition was generated by automatically transforming the corresponding data portal code; it closely mimicks the JSON metadata returned by the data portal back end from the station URI id.
		"""
		station_uri: str
